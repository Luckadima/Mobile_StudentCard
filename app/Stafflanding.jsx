      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            ...
            // Optionally, save the current time spent before logging out
  ...
  return (
    <>
      <LinearGradient colors={['#FF4500', '#A9A9A9', '#000000']} style={styles.gradient}>
        ...
        <View style={styles.buttonWrapper}>
          <Animated.View style={[styles.buttonContainer1]}>
            <Pressable onPress={Staffdetails}>
